            ...
            <div className="container mx-auto">
                ...
                <div className="flex justify-center items-center">
                    ...
                    <div className="flex items-center justify-center">
                        <TestimonialButton ariaLabel="Previous testimonial" path="M10 19l-7-7m0 0l7-7m-7 7h18" />
                        <TestimonialButton ariaLabel="Next testimonial" path="M14 5l7 7m0 0l-7 7m7-7H3" />
                    </div>
                </div>
            </div>
        </section>
...
const TestimonialButton = ({ ariaLabel, path }) => {
    return (
        <button className="h-full px-4 text-gray-800 hover:text-fuchsia-700" aria-label={ariaLabel}>
